...
<body>
<input type="hidden" id="statu" value="<%=request.getAttribute("statut") %>">
		...
		<section class="signup">
			<div class="container">
				<div class="signup-content">
					...
					<img src=images/logooo.png><span style="font-size:20px"><b>StarPost</b></span><br><br>
						<figure>
